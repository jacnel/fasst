...
void hrd_connect_qp(struct hrd_ctrl_blk *cb, int n,
...
#if HRD_ENABLE_ROCE == 1
  conn_attr.ah_attr.is_global = 1;
  conn_attr.ah_attr.dlid = 0;
  conn_attr.ah_attr.grh.dgid.global.interface_id = remote_qp_attr->interface_id;
  conn_attr.ah_attr.grh.dgid.global.subnet_prefix =
      remote_qp_attr->subnet_prefix;
  ...
  conn_attr.ah_attr.dlid = 0;
  conn_attr.ah_attr.grh.dgid.global.interface_id = remote_qp_attr->interface_id;
  conn_attr.ah_attr.grh.dgid.globbal.subnet_prefix =
      remote_qp_attr->subnet_prefix;
  conn_attr.ah_attr.grh.flow_label = 0;
  conn_attr.ah_attr.grh.traffic_class = 0;
  conn_attr.ah_attr.grh.sgid_inidex = 0;
  conn_attr.ah_attr.grh.hop_limit = 1;
#else
  conn_attr.ah_attr.is_global = 0;
  conn_attr.ah_attr.dlid = remote_qp_attr->lid;
