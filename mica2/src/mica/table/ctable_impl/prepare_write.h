#pragma once
#ifndef MICA_TABLE_CTABLE_IMPL_PREPARE_WRITE_H_
#define MICA_TABLE_CTABLE_IMPL_PREPARE_WRITE_H_

namespace mica {
namespace table {

template <class StaticConfig>
Result CTable<StaticConfig>::prepare_write(uint32_t caller_id,
  ...
  if (!item->pending) {
    ...
    pool_->unlock();
    // unlock_bucket(bucket);  //! Leave locked
