#pragma once
#ifndef MICA_TABLE_CTABLE_IMPL_INIT_H_
#define MICA_TABLE_CTABLE_IMPL_INIT_H_

namespace mica {
namespace table {
template <class StaticConfig>
CTable<StaticConfig>::CTable(const ::mica::util::Config& config, Alloc* alloc,
                             Pool* pool, EvictionCallback callback)
    : config_(config), alloc_(alloc), pool_(pool), callback_(callback) {
...
template <class StaticConfig>
void CTable<StaticConfig>::reset() {
  size_t bucket_index;
