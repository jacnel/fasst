#pragma once
#ifndef MICA_TABLE_CTABLE_IMPL_INCREMENT_H_
#define MICA_TABLE_CTABLE_IMPL_INCREMENT_H_

namespace mica {
namespace table {
template <class StaticConfig>
Result CTable<StaticConfig>::increment(uint64_t key_hash, const char* key,
